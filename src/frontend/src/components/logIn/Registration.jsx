        ...
        <div className='logIn'>
            ...
            <div className="logIn__form">
                <div className="logIn__form-item">
                    ...
                    <input type="text" placeholder="Your First Name" value={firstName} onChange={handleFirstNameChange} className="logIn__form-input" />
                </div>
                <div className="logIn__form-item">
                    <div className="logIn__form-icon">
                    ...
                    <input type="text" placeholder="Your Last Name" value={lastName} onChange={handleLastNameChange} className="logIn__form-input" />
                </div>
                <div className="logIn__form-item">
                    <div className="logIn__form-icon">
                    ...
                    <input type="email" placeholder="Your Email" value={email} onChange={handleEmailChange} className="logIn__form-input" />
                </div>
                <div className="logIn__form-item">
                    <div className="logIn__form-icon">
                    ...
                    <input type="password" className="logIn__form-input" value={password} onChange={handlePasswordChange}  placeholder="Your Password"/>
                </div>
                <div className="logIn__form-item">
                    <div className="logIn__form-icon">
