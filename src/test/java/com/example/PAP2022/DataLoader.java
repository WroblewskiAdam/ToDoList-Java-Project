...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Image image1 = new Image("1111111111", "image/jpeg", HexFormat.of().parseHex("e04fd020ea3a6910a2d808002b30309d"));
        Image image2 = new Image("2222222222", "image/jpeg", HexFormat.of().parseHex("e04fd020ea3a6910a2d808002b30309d"));
        Image image3 = new Image("3333333333", "image/jpeg", HexFormat.of().parseHex("e04fd020ea3a6910a2d808002b30309d"));
        Image image4 = new Image("4444444444", "image/jpeg", HexFormat.of().parseHex("e04fd020ea3a6910a2d808002b30309d"));
